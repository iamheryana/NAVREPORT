...
public class LapWebinarQACtrl extends GFCBaseCtrl implements Serializable {
	...
	protected Window windowLapWebinarQA;
	...
	public void onClick$btnSearchWebinarID(Event event)  {
		T05WebinarEvent webId = T05WebinarEventLOV.show(windowLapWebinarQA);
