...
public class DisplayNoDocumentWindow extends Window implements Serializable {
	...
	public static String show(Component parent, String NoPenawaran, String titleDocument) {
		return new DisplayNoDocumentWindow(parent, NoPenawaran, titleDocument).resultValue;
	}

	private DisplayNoDocumentWindow(Component parent, String NoPenawaran, String titleDocument)  {
		super();
		this.initValue = NoPenawaran;
		this.initTitle = titleDocument;
		setParent(parent);
		createBox();
	}
