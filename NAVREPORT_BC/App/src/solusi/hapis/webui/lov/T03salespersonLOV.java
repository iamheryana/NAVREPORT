...
public class T03salespersonLOV extends Window implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 8670130834282295623L;
	private static final Logger logger =Logger.getLogger(T03salespersonLOV.class);
     ...
     *     public static M01area show(Component parent) {
        return new T03salespersonLOV(parent).getObj();
    }
     */
    ...
    private T03salespersonLOV(Component parent) {
        super();
    ...
    private void createBox() {
         ...
         */
        ResultObject ro = getObjService().getListT03salespersonLOV(null, 0, getPageSize());
    ...
    void refreshModel(int start) {
        ...
        // init the model
        ResultObject ro = getObjService().getListT03salespersonLOV(parameterInput, start, getPageSize());
        List<T03salesperson> resultList = (List<T03salesperson>) ro.getList();
        this._paging.setTotalSize(ro.getTotalCount());
    ...
    final class OnCloseListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            if (T03salespersonLOV.this.listbox.getSelectedItem() != null) {
                Listitem li = T03salespersonLOV.this.listbox.getSelectedItem();
                T03salesperson rec = (T03salesperson) li.getAttribute("data");
