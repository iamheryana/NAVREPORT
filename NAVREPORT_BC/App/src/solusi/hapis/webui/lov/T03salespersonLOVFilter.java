...
public class T03salespersonLOVFilter extends Window implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 8670130834282295623L;
	private static final Logger logger =Logger.getLogger(T03salespersonLOVFilter.class);
    ...
    private T03salesperson obj = null;

    // The service from which we get the data
    private T03salespersonService objService;
     ...
     *     public static M01area show(Component parent) {
        return new T03salespersonLOVFilter(parent).getObj();
    }
     */
    
    public static T03salesperson show(Component parent){
    	return new T03salespersonLOVFilter(parent).getObj();
    }

    private T03salespersonLOVFilter(Component parent) {
        super();
    ...
    private void createBox() {
         ...
         */
        ResultObject ro = getObjService().getListT03salespersonLOVFilter(null, 0, getPageSize());
        List<T03salesperson> resultList = (List<T03salesperson>) ro.getList();
    ...
    final class SearchBoxItemRenderer implements ListitemRenderer {
        ...
        public void render(Listitem item, Object data) throws Exception {
        	...
        	T03salesperson rec = (T03salesperson) data;
    ...
    public void onDoubleClicked(Event event) {
        ...
        if (this.listbox.getSelectedItem() != null) {
            ...
            T03salesperson rec = (T03salesperson) li.getAttribute("data");
    ...
    void refreshModel(int start) {
        ...
        // init the model
        ResultObject ro = getObjService().getListT03salespersonLOVFilter(parameterInput, start, getPageSize());
        List<T03salesperson> resultList = (List<T03salesperson>) ro.getList();
        this._paging.setTotalSize(ro.getTotalCount());
    ...
    final class OnCloseListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            if (T03salespersonLOVFilter.this.listbox.getSelectedItem() != null) {
                Listitem li = T03salespersonLOVFilter.this.listbox.getSelectedItem();
                T03salesperson rec = (T03salesperson) li.getAttribute("data");
	...
	public void setObj(T03salesperson obj) {
		this.obj = obj;
	}

	public T03salesperson getObj() {
		return obj;
	}

	public void setObjService(T03salespersonService objService) {
		this.objService = objService;
	}

	public T03salespersonService getObjService() {
		if (this.objService == null){
			this.objService = (T03salespersonService) SpringUtil.getBean("t03salespersonService");
		}
		return objService;
	}
