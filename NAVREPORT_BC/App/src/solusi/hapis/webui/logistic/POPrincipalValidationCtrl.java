...
public class POPrincipalValidationCtrl extends GFCBaseCtrl implements Serializable {
	...
	public void onClick$btnOK(Event event) throws InterruptedException, ParseException {
		...
		String vSync = callStoreProcOrFuncService.callSyncAReport("0301002");
		
		
		String jasperRpt = "/solusi/hapis/webui/reports/logistic/03005_POPrinsipalValidation.jasper";
