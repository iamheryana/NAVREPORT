...
public class OutSOPayPositionCtrl extends GFCBaseCtrl implements Serializable {
	...
	protected Radiogroup rdgAmt;	 
	protected Radio rdDPP;
	protected Radio rdPPN;
	...
	protected Combobox  cmbGroupSO;
	
	protected Row rowGroupSO;
	...
	public void onClick$btnOK(Event event) throws InterruptedException, ParseException {
		...
		if (StringUtils.isNotEmpty(rdgLaporan.getSelectedItem().getValue())) {
			vDetail = rdgLaporan.getSelectedItem().getValue();	
		} 
		
		String vGroupSO = "ALL";
		if (cmbGroupSO.getSelectedItem().getValue() != null){
			vGroupSO = (String) cmbGroupSO.getSelectedItem().getValue();
		}
		
		String vIncludePPN = "Y";
		if (StringUtils.isNotEmpty(rdgAmt.getSelectedItem().getValue())) {
			vIncludePPN = rdgAmt.getSelectedItem().getValue();	
		} 
		...
		String jasperRpt = "/solusi/hapis/webui/reports/logistic/03037_OutSOPayPosition.jasper";
		
		if (vDetail.equals("N2")== true) {
			jasperRpt =  "/solusi/hapis/webui/reports/logistic/03037_01_OutSOPayPosition.jasper";
		} else {
			jasperRpt =  "/solusi/hapis/webui/reports/logistic/03037_OutSOPayPosition.jasper";
		}
		...
		param.put("IncludePPN",  vIncludePPN);
		...
		if(vDetail.equals("N2") == true){			
			param.put("Detail",  "N");
			param.put("GroupSO",  "ALL");
		} else {
			param.put("Detail",  vDetail);
			
			if(vDetail.equals("N") == true){
				param.put("GroupSO",  "ALL");
			} else {
				param.put("GroupSO",  vGroupSO);
			}
		}
