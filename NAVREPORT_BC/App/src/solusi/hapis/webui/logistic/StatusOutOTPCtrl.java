...
public class StatusOutOTPCtrl extends GFCBaseCtrl implements Serializable {
	...
	public void onClick$btnOK(Event event) throws InterruptedException {
		...
		String vSync = callStoreProcOrFuncService.callSyncAReport("0306008");	
		

		String jasperRpt = "/solusi/hapis/webui/reports/logistic/03039_StatusOutOTP.jasper";
