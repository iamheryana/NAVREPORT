...
public class InvoiceZebraCampaignNewCtrl extends GFCBaseCtrl implements Serializable {
	...
	public void onClick$btnOK(Event event) throws InterruptedException, ParseException {
		...
		String jasperRpt = "/solusi/hapis/webui/reports/logistic/03030_InvoiceZebraCampaign_v2_SUM.jasper";
		
		
		
		if(vJnsRpt.equals("SUM") == true){
			@SuppressWarnings("unused")
			String vSync = callStoreProcOrFuncService.callSyncAReport("0304003");
			
			
			jasperRpt = "/solusi/hapis/webui/reports/logistic/03030_InvoiceZebraCampaign_v2_SUM.jasper";
		} else {
			@SuppressWarnings("unused")
			String vSync = callStoreProcOrFuncService.callSyncAReport("0304002");
			
			jasperRpt = "/solusi/hapis/webui/reports/logistic/03030_InvoiceZebraCampaign_v2.jasper";
		}
