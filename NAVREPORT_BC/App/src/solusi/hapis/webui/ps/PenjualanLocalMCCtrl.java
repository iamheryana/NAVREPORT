...
public class PenjualanLocalMCCtrl extends GFCBaseCtrl implements Serializable {
	...
	public void onClick$btnOK(Event event) throws InterruptedException, ParseException {
		...
		String vSync = callStoreProcOrFuncService.callSyncAReport("0601006");
		
		
		String jasperRpt = "/solusi/hapis/webui/reports/ps/05010_PenjualanLocalMC.jasper";
		
				

		param.put("JenisRpt",  vJenisLap); 
