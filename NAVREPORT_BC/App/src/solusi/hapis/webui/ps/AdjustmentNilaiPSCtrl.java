...
public class AdjustmentNilaiPSCtrl extends GFCBaseCtrl implements Serializable {
	...
	public void onClick$btnOK(Event event) throws InterruptedException, ParseException {
		...
		String vSync = callStoreProcOrFuncService.callSyncAReport("0601003");
		
		
		String jasperRpt = "/solusi/hapis/webui/reports/ps/05006_01_AdjustmetNilaiPSSum.jasper";
		
		if  (vJenisLap.equals("SUM") == true ){
			jasperRpt = "/solusi/hapis/webui/reports/ps/05006_01_AdjustmetNilaiPSSum.jasper";
		} else {
			jasperRpt = "/solusi/hapis/webui/reports/ps/05006_02_AdjustmetNilaiPSDetail.jasper";
		}
