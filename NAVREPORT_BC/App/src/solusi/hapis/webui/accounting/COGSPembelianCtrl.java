...
public class COGSPembelianCtrl extends GFCBaseCtrl implements Serializable {
	...
	public void onClick$btnOK(Event event) throws InterruptedException, ParseException {
		...
		String vSync = callStoreProcOrFuncService.callSyncAReport("0105002");
		
	
		String jasperRpt = "/solusi/hapis/webui/reports/accounting/01047_COGSPembelian.jasper";
