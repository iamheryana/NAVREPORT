...
public class CrossCheckedInvoiceBUMNCtrl extends GFCBaseCtrl implements Serializable {
	...
	public void onClick$btnOK(Event event) throws InterruptedException {
		...
		String vSync = callStoreProcOrFuncService.callSyncAReport("0103011");	
		
		String jasperRpt = "/solusi/hapis/webui/reports/accounting/01044_CrossCheckedInvoiceBUMN.jasper";
