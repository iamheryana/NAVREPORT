...
public class RegisterWOCtrl extends GFCBaseCtrl implements Serializable {
	...
	public void onClick$btnOK(Event event) throws InterruptedException, ParseException {
		...
		String vSync = callStoreProcOrFuncService.callSyncAReport("0105003");
		
		
		
		String jasperRpt = "/solusi/hapis/webui/reports/accounting/01048_RegisterWO.jasper";
