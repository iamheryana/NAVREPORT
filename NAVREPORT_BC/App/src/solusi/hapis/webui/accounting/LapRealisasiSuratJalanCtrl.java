...
public class LapRealisasiSuratJalanCtrl extends GFCBaseCtrl implements Serializable {
...
//		}
		...
		String jasperRpt = "/solusi/hapis/webui/reports/accounting/01007_AJRealisasiSuratJalan.jasper";
		
		if(vCompany.equals("AUTOJAYA")){
			jasperRpt = "/solusi/hapis/webui/reports/accounting/01007_AJRealisasiSuratJalan.jasper";
		} else {
			jasperRpt = "/solusi/hapis/webui/reports/accounting/01008_SPRealisasiSuratJalan.jasper";
		}
		
    	param.put("SJFrom",  vTglFrom); 
		param.put("SJUpto",  vTglTo);  
		...
		param.put("From",  vTglInvFrom); 
		param.put("Upto",  vTglInvTo);  
