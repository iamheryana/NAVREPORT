...
public class RekapPenjualanBulananCtrl extends GFCBaseCtrl implements Serializable {
	...
	public void onClick$btnOK(Event event) throws InterruptedException, ParseException {
		...
		String vSync = callStoreProcOrFuncService.callSyncAReport("0109001");		
		
		
		
		String jasperRpt = "/solusi/hapis/webui/reports/accounting/lapKeuanganExternal/010901_RekapPenjualanBulanan.jasper";
		
	
    	param.put("PeriodeFrom",  vTglFrom); 
		param.put("PeriodeUpto",  vTglTo);  
		param.put("Company",  vCompany);  
		param.put("jnsLap",  vJenisLap);  
