...
public class T33CostingD_OTHER_AddWindow extends Window implements Serializable {
	private static final long serialVersionUID = 7826099855146654896L;
	
	// binding
	private T33CostingDOther initValue;
	private T33CostingDOther resultValue;
	...
	public static T33CostingDOther show(Component parent, T33CostingDOther t33CostingDOther, T29CostingH t29CostingH, String modeTitle, SelectQueryService selectQueryService) {
		return new T33CostingD_OTHER_AddWindow(parent, t33CostingDOther, t29CostingH, modeTitle, selectQueryService).resultValue;
	}

	private T33CostingD_OTHER_AddWindow(Component parent, T33CostingDOther t33CostingDOther, T29CostingH t29CostingH, String modeTitle, SelectQueryService selectQueryService) {
		super();
		this.initValue = t33CostingDOther;
			...
			Groupbox groupboxDtl = new Groupbox();
				...
				Grid gridDtl = new Grid();
					...
					Rows rowsDtl = new Rows();
						...
						Row rowDtl3 = new Row();	
							new Label("Cost").setParent(rowDtl3);
							...
							this.decCogsSatuan.setParent(rowDtl3);	
							...
							this.decCogsTotal.setParent(rowDtl3);							
