...
public class T31CostingD_ACSPS_Comparator implements Comparator<Object>, Serializable {
	...
	public T31CostingD_ACSPS_Comparator(boolean asc, int type) {
		this.asc = asc;
		this.type = type;
	}
	...
	public int compare(Object o1, Object o2) {
		T31CostingDAcsps obj1 = (T31CostingDAcsps) o1;
		T31CostingDAcsps obj2 = (T31CostingDAcsps) o2;
		switch (type) {
		case 1: 
