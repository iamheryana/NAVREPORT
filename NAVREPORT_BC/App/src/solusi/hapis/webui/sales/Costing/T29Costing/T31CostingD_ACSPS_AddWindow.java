...
public class T31CostingD_ACSPS_AddWindow extends Window implements Serializable {
	private static final long serialVersionUID = 7826099855146654896L;
	
	// binding
	private T31CostingDAcsps initValue;
	private T31CostingDAcsps resultValue;
	...
	public static T31CostingDAcsps show(Component parent, T31CostingDAcsps t31CostingDAcsps, T29CostingH t29CostingH, String modeTitle, SelectQueryService selectQueryService) {
		return new T31CostingD_ACSPS_AddWindow(parent, t31CostingDAcsps, t29CostingH, modeTitle, selectQueryService).resultValue;
	}

	private T31CostingD_ACSPS_AddWindow(Component parent, T31CostingDAcsps t31CostingDAcsps, T29CostingH t29CostingH, String modeTitle, SelectQueryService selectQueryService) {
		super();
		this.initValue = t31CostingDAcsps;
	...
	private void createBox() {
		...
		caption.setLabel("ACS Profesional Services - "+modeTitle);
