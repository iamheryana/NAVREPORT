...
public class ForecastSummaryCtrl extends GFCBaseCtrl implements Serializable {
...
//		cmbPotensialReal.setSelectedIndex(0);
	...
	public void onClick$btnOK(Event event) throws InterruptedException {
		...
		String jasperRpt = "/solusi/hapis/webui/reports/sales/04039_ForecastSummary_02.jasper";
		...
		if(vPot.equals("ALL")){
			jasperRpt = "/solusi/hapis/webui/reports/sales/04039_ForecastSummary_02.jasper";
		} else{
			jasperRpt = "/solusi/hapis/webui/reports/sales/04039_ForecastSummary.jasper";
		}
