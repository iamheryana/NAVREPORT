...
public class P02VendorNonnavLOV extends Window implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 8670130834282295623L;
	private static final Logger logger =Logger.getLogger(P02VendorNonnavLOV.class);
	
    private Textbox txtKode;
    private Textbox txtValutaTrans;
    private Textbox txtNamaPenerima;
    private Textbox txtNamaBank;
    ...
    // the windows title
    private final String _title = "Search Vendor Non NAV - Bank Account";
    ...
    private P02VendorNonnav obj = null;

    // The service from which we get the data
    private P02VendorNonnavService objService;
     ...
     *     public static M01area show(Component parent) {
        return new P02VendorNonnavLOV(parent).getObj();
    }
     */
    
    public static P02VendorNonnav show(Component parent){
    	return new P02VendorNonnavLOV(parent).getObj();
    }

    private P02VendorNonnavLOV(Component parent) {
        super();
    ...
    private void createBox() {
        ...
        listheaderKode.setLabel("Kode");
        listheaderKode.setSortAscending(new FieldComparator("kode", true));
        listheaderKode.setSortDescending(new FieldComparator("kode", false));
        listheaderKode.setSort("auto");
        
        Listheader listheaderValutaTrans = new Listheader();
        listheaderValutaTrans.setSclass("FDListBoxHeader1");
        listheaderValutaTrans.setParent(listhead);
        listheaderValutaTrans.setWidth("30%");
        listheaderValutaTrans.setLabel("Valuta Transaksi");
        listheaderValutaTrans.setSortAscending(new FieldComparator("valutaTrans", true));
        listheaderValutaTrans.setSortDescending(new FieldComparator("valutaTrans", false));
        listheaderValutaTrans.setSort("auto");
        
        Listheader listheaderNamaPenerima = new Listheader();
        listheaderNamaPenerima.setSclass("FDListBoxHeader1");
        listheaderNamaPenerima.setParent(listhead);
        listheaderNamaPenerima.setWidth("30%");
        listheaderNamaPenerima.setLabel("Nama Penerima");
        listheaderNamaPenerima.setSortAscending(new FieldComparator("namaPenerima", true));
        listheaderNamaPenerima.setSortDescending(new FieldComparator("namaPenerima", false));
        listheaderNamaPenerima.setSort("auto");
        
        Listheader listheaderNamaBank = new Listheader();
        listheaderNamaBank.setSclass("FDListBoxHeader1");
        listheaderNamaBank.setParent(listhead);
        listheaderNamaBank.setWidth("30%");
        listheaderNamaBank.setLabel("Nama Bank");
        listheaderNamaBank.setSortAscending(new FieldComparator("namaBank", true));
        listheaderNamaBank.setSortDescending(new FieldComparator("namaBank", false));
        listheaderNamaBank.setSort("auto");
        ...
        Auxheader auxValutaTrans = new Auxheader();
        this.txtValutaTrans = new Textbox();
        this.txtValutaTrans.setWidth("95%");
        this.txtValutaTrans.setParent(auxValutaTrans);
        auxValutaTrans.setParent(auxhead);
        
        Auxheader auxNamaPenerima = new Auxheader();
        this.txtNamaPenerima = new Textbox();
        this.txtNamaPenerima.setWidth("95%");
        this.txtNamaPenerima.setParent(auxNamaPenerima);
        auxNamaPenerima.setParent(auxhead);
        
        Auxheader auxNamaBank = new Auxheader();
        this.txtNamaBank = new Textbox();
        this.txtNamaBank.setWidth("95%");
        this.txtNamaBank.setParent(auxNamaBank);
        auxNamaBank.setParent(auxhead);
         ...
         */
        ResultObject ro = getObjService().getListP02VendorNonnavLOV(null, 0, getPageSize());
        List<P02VendorNonnav> resultList = (List<P02VendorNonnav>) ro.getList();
    ...
    final class OnClearListener implements EventListener{
    	...
    	public void onEvent(Event event) throws Exception {
    		...
    		txtKode.setValue("");
    		txtValutaTrans.setValue("");
    		txtNamaPenerima.setValue("");
    		txtNamaBank.setValue("");
    ...
    final class SearchBoxItemRenderer implements ListitemRenderer {
        ...
        public void render(Listitem item, Object data) throws Exception {
        	...
        	P02VendorNonnav rec = (P02VendorNonnav) data;

            Listcell lc1 = new Listcell(rec.getKode());
            lc1.setParent(item);

            Listcell lc2 = new Listcell(rec.getValutaTrans());
            lc2.setParent(item);
            
            Listcell lc3 = new Listcell(rec.getNamaPenerima());
            lc3.setParent(item);
            
            Listcell lc4 = new Listcell(rec.getNamaBank());
            lc4.setParent(item);
    ...
    public void onDoubleClicked(Event event) {
        ...
        if (this.listbox.getSelectedItem() != null) {
            ...
            P02VendorNonnav rec = (P02VendorNonnav) li.getAttribute("data");
    ...
    void refreshModel(int start) {
        ...
        // init the model
        ResultObject ro = getObjService().getListP02VendorNonnavLOV(parameterInput, start, getPageSize());
        List<P02VendorNonnav> resultList = (List<P02VendorNonnav>) ro.getList();
        this._paging.setTotalSize(ro.getTotalCount());
    ...
    final class OnCloseListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            if (P02VendorNonnavLOV.this.listbox.getSelectedItem() != null) {
                Listitem li = P02VendorNonnavLOV.this.listbox.getSelectedItem();
                P02VendorNonnav rec = (P02VendorNonnav) li.getAttribute("data");
	...
	public void setObj(P02VendorNonnav obj) {
		this.obj = obj;
	}

	public P02VendorNonnav getObj() {
		return obj;
	}

	public void setObjService(P02VendorNonnavService objService) {
		this.objService = objService;
	}

	public P02VendorNonnavService getObjService() {
		if (this.objService == null){
			this.objService = (P02VendorNonnavService) SpringUtil.getBean("p02VendorNonnavService");
		}
		return objService;
	}
