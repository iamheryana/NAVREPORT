...
public class M02SalespersonAddDetailWindow extends Window implements Serializable {
	private static final long serialVersionUID = 7826099855146654896L;

	// binding
	private M03Targetsales initValue;
	private M03Targetsales resultValue;
	
	private M02Salesperson initM02Salesperson;
	...
	public static M03Targetsales show(Component parent, M03Targetsales t08targetsales, M02Salesperson t03salesperson) {
		return new M02SalespersonAddDetailWindow(parent, t08targetsales, t03salesperson).resultValue;
	}

	private M02SalespersonAddDetailWindow(Component parent, M03Targetsales t08targetsales, M02Salesperson t03salesperson) {
		super();
		this.initValue = t08targetsales;
		this.initM02Salesperson = t03salesperson;
		setParent(parent);
		createBox();
	}
