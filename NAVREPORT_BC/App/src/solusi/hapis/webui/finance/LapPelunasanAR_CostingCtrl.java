...
public class LapPelunasanAR_CostingCtrl extends GFCBaseCtrl implements Serializable {
	...
	public void onClick$btnOK(Event event) throws InterruptedException {
		...
		String jasperRpt = "/solusi/hapis/webui/reports/finance/02030_AJPelunasanAR-Costing.jasper";
		
		if(vCompany.equals("AJ")){
			jasperRpt = "/solusi/hapis/webui/reports/finance/02030_AJPelunasanAR-Costing.jasper";
		} else {
			jasperRpt = "/solusi/hapis/webui/reports/finance/02031_SPPelunasanAR-Costing.jasper";
		}
