 ...
 */
package solusi.hapis.webui.security.userrole;
...
import solusi.hapis.webui.security.groupright.SecGrouprightCtrl;
import solusi.hapis.webui.security.userrole.model.SecUserroleRoleListModelItemRenderer;
import solusi.hapis.webui.security.userrole.model.SecUserroleUserListModelItemRenderer;
...
public class SecUserroleCtrl extends GFCBaseCtrl implements Serializable, SelectionCtrl<SecUser> {
	...
	public void onCreate$secUserroleWindow(Event event) throws Exception {
        ...
        btnSave.setVisible(getUserWorkspace().isAllowed("button_userRoles_btnSave"));
    }
    ...
    /*
      * (non-Javadoc)
      *
      * @see id.co.club.webui.util.SelectionCtrl#getSelected()
      */
    @Override
