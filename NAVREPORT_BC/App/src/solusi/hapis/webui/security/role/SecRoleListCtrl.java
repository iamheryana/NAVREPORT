...
import solusi.hapis.webui.security.role.model.SecRoleListModelItemRenderer;
import solusi.hapis.webui.security.role.report.SecRoleSimpleDJReport;
...
public class SecRoleListCtrl extends GFCBaseListCtrl<SecRole> implements Serializable {
     ...
     * see: id.co.club.webui.security.role.model.SecRoleListModelItemRenderer.
     * java <br>
     *
     * @param event
     * @throws Exception
