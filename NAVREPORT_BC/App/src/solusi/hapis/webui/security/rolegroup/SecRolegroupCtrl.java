...
import solusi.hapis.webui.security.rolegroup.model.SecRolegroupGroupListModelItemRenderer;
import solusi.hapis.webui.security.rolegroup.model.SecRolegroupRoleListModelItemRenderer;
...
public class SecRolegroupCtrl extends GFCBaseCtrl implements Serializable, SelectionCtrl<SecRole> {
    ...
    /*
      * (non-Javadoc)
      *
      * @see solusi.hapis.webui.util.SelectionCtrl#getSelected()
      */
    @Override
