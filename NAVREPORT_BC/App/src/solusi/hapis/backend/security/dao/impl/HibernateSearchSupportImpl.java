...
public class HibernateSearchSupportImpl implements HibernateSearchSupport {
    ...
    /*
      ...
      *
      * @see
      * solusi.hapis.backend.dao.impl.HibernateSearchSupport#count(java.lang.
    ...
    /*
      ...
      *
      * @see
      * solusi.hapis.backend.dao.impl.HibernateSearchSupport#count(com.trg.search
      * .ISearch)
      */
    ...
    /*
      ...
      *
      * @see
      * solusi.hapis.backend.dao.impl.HibernateSearchSupport#generateQL(java.
    ...
    /*
      ...
      *
      * @see
      * solusi.hapis.backend.dao.impl.HibernateSearchSupport#generateRowCountQL
    ...
    /*
      ...
      *
      * @see
      * solusi.hapis.backend.dao.impl.HibernateSearchSupport#getFilterFromExample
      * (java.lang.Object)
      */
    ...
    /*
      ...
      *
      * @see
      * solusi.hapis.backend.dao.impl.HibernateSearchSupport#search(java.lang
      * .Class, com.trg.search.ISearch)
      */
    ...
    /*
      ...
      *
      * @see
      * solusi.hapis.backend.dao.impl.HibernateSearchSupport#search(com.trg.search
      * .ISearch)
      */
    @SuppressWarnings("unchecked")
    ...
    /*
      ...
      *
      * @see
      * solusi.hapis.backend.dao.impl.HibernateSearchSupport#searchAndCount(java
    ...
    /*
      ...
      *
      * @see
      * solusi.hapis.backend.dao.impl.HibernateSearchSupport#searchAndCount(com
      * .trg.search.ISearch)
      */
    @SuppressWarnings("unchecked")
    ...
    /*
      ...
      *
      * @see
      * solusi.hapis.backend.dao.impl.HibernateSearchSupport#searchUnique(java
      * .lang.Class, com.trg.search.ISearch)
      */
    @SuppressWarnings("unchecked")
    ...
    /*
      ...
      *
      * @see
      * solusi.hapis.backend.dao.impl.HibernateSearchSupport#searchUnique(com
      * .trg.search.ISearch)
      */
