	...
	public List<SecRight> getListSecRight(Map<Object, Object> parameterInput) {
		...
		if (parameterInput != null) {
			if (parameterInput.get("rigName") != null) {
				criteria.add(Restrictions.like("rigName", parameterInput.get("rigName").toString(), MatchMode.ANYWHERE));
			}
			if (parameterInput.get("rigType") != null) {
				criteria.add(Restrictions.eq("rigType", parameterInput.get("rigType")));
			}
			if (parameterInput.get("parentId") != null) {
				criteria.add(Restrictions.eq("parentId", parameterInput.get("parentId")));
			}
		}
