...
*/
--SCRIPT INI DIHASILKAN OLEH CLARION SYNCHRONIZER
--DAN SUDAH MENGALAMI EDITING

--SCRIPT INI UNTUK ; create TABLE
--BISA LANGSUNG DI-RUN


--SCRIPT INI SUDAH ADA TAMBAHAN MODIFIKASI S/D 01.08.2001
-- UPDATED 04.05.2005 : 
--	TRANSAKSI DAN SUMMARY MUTASI 
--		MODI FIELD KETERANGAN VARCHAR(40) JADI VARCHAR(100) 
--		TAMBAH 4 FIELD KETERANGAN
-- 	JUDUL FORMAT, HEADER FORMAT, DETAIL FORMAT : NEW TABLES 
...
-- LDA-1
 CREATE TABLE FZ1FLDA(
   ...
   KdSakitSrtDr VARCHAR(4) ,
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT KEYFZ1 PRIMARY KEY (FZ1_ID))

;
CREATE UNIQUE INDEX FZ1UK1 ON FZ1FLDA (KODE);
...
CREATE TABLE FZ2FLDA(
   ...
   FaktorXPajak DECIMAL(6,2) , 
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
  CONSTRAINT FZ2Key1 PRIMARY KEY (FZ2_ID));

CREATE UNIQUE INDEX FZ2UK1 ON FZ2FLDA (KODE);
...
CREATE TABLE M40CURR(
   ...
   Ws VARCHAR(1) ,
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M40Key1 PRIMARY KEY (M40_ID));
   
   CREATE UNIQUE INDEX M40UK1 ON M40CURR (KDCURR);
...
CREATE TABLE M21UMRE(
   ...
   TglMulai DATE NOT NULL,
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M21Key1 PRIMARY KEY (M21_ID))
; 
   create INDEX M21Key2 ON M21UMRE(Daerah) ; 
   CREATE UNIQUE INDEX M21UK1 ON M21UMRE (Daerah,TglMulai) ;
...
CREATE TABLE M01AREA(
   ...
   Ws VARCHAR(1) ,
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M01Key1 PRIMARY KEY (M01_ID));
   
   create INDEX M01Key2 ON M01AREA(UMR) ;
   CREATE UNIQUE INDEX M01UK1 ON M01AREA (Kode) ;
...
CREATE TABLE M02UUSA(
   ...
   Ws VARCHAR(1) ,
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M02Key1 PRIMARY KEY (M02_ID));

   CREATE UNIQUE INDEX M02UK1 ON M02UUSA (Kode) ;
-- Kelompok JKK 
ALTER TABLE M02UUSA
...
create INDEX M05Key2 ON M05DJAB(Kode) ;
create INDEX M05Key3 ON M05DJAB(FlgDpPt,KdDpPt) ;
...
ALTER TABLE M05DJAB ADD
   CONSTRAINT M05Key2 FOREIGN KEY (Kode)
   REFERENCES M04HJAB(Kode)  ON DELETE CASCADE ;
...
CREATE TABLE M07DKJB(
 ...
 create INDEX M07Key2 ON M07DKJB(Kode) ;
 create INDEX M07Key3 ON M07DKJB(FlgDpPt,KdDpPt) ;
...
ALTER TABLE M07DKJB ADD
   CONSTRAINT M07Key2 FOREIGN KEY (Kode)
   REFERENCES M06HKJB(Kode)  ON DELETE CASCADE ;
ALTER TABLE M07DKJB ADD
...
CREATE TABLE M09DCAB(
  ...
  create INDEX M09Key2 ON M09DCAB(KdCab) ;
  create INDEX M09Key3 ON M09DCAB(FlgDpPt,KdDpPt) ;
...
ALTER TABLE M09DCAB ADD
   CONSTRAINT M09Key2 FOREIGN KEY (KdCab)
   REFERENCES M08HCAB(KdCaba)  ON DELETE CASCADE ;
ALTER TABLE M09DCAB ADD
...
CREATE TABLE M10KLAS(
   ...
   M41_ID INTEGER, 
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M10Key1 PRIMARY KEY (M10_ID)) ;

   CREATE UNIQUE INDEX M10UK1 ON M10KLAS (Kode) ;
...
create INDEX M13Key2 ON M13DGOL(Kode) ;
create INDEX M13Key3 ON M13DGOL(FlgDpPt,KdDpPt) ;
...
ALTER TABLE M13DGOL ADD
   CONSTRAINT M13Key2 FOREIGN KEY (Kode)
   REFERENCES M12HGOL(Kode)  ON DELETE CASCADE ;
ALTER TABLE M13DGOL ADD
...
CREATE TABLE M14BANK(
   ...
   biayabank DECIMAL(13,2) ,
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M14Key1 PRIMARY KEY (M14_ID)); 

   CREATE UNIQUE INDEX M14UK1 ON M14BANK (Kode) ;
...
CREATE TABLE M16ALKL(
   ...
   Ws VARCHAR(1) ,
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M16Key1 PRIMARY KEY (M16_ID)) ;

   CREATE UNIQUE INDEX M16UK1 ON M16ALKL (Kode) ;
...
CREATE TABLE M17UKER(
   ...
   Ws VARCHAR(1) ,
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M17Key1 PRIMARY KEY (M17_ID)) ; 
...
CREATE TABLE M15PEGA(
   ...
   M40_ID INTEGER, 
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M15Key1 PRIMARY KEY (M15_ID)) ;
...
create INDEX M15Key4 ON M15PEGA(KdJaba) ;
create INDEX M15Key5 ON M15PEGA(KdKJab) ;
create INDEX M15Key6 ON M15PEGA(KdCaba) ;
create INDEX M15Key7 ON M15PEGA(KdKlas) ;
create INDEX M15Key8 ON M15PEGA(KdGlng) ;
...
ALTER TABLE M15PEGA ADD
   CONSTRAINT M15Key4 FOREIGN KEY (KdJaba) 
   REFERENCES M04HJAB(Kode) ON UPDATE RESTRICT ON DELETE RESTRICT ; 
ALTER TABLE M15PEGA ADD
   CONSTRAINT M15Key5 FOREIGN KEY (KdKJab)
   REFERENCES M06HKJB(Kode) ON UPDATE RESTRICT ON DELETE RESTRICT ;
ALTER TABLE M15PEGA ADD
   CONSTRAINT M15Key6 FOREIGN KEY (KdCaba)
   REFERENCES M08HCAB(KdCaba) ON UPDATE RESTRICT ON DELETE RESTRICT ;
ALTER TABLE M15PEGA ADD
   CONSTRAINT M15Key7 FOREIGN KEY (KdKlas)
   REFERENCES M10KLAS(Kode) ON UPDATE RESTRICT ON DELETE RESTRICT ;
ALTER TABLE M15PEGA ADD
   CONSTRAINT M15Key8 FOREIGN KEY (KdGlng)
   REFERENCES M12HGOL(Kode) ON UPDATE RESTRICT ON DELETE RESTRICT ;
ALTER TABLE M15PEGA ADD
...
create INDEX M23Key2 ON M23KLRG(NIP) ; 
...
CREATE TABLE M33JABT(
   ...
   Ws VARCHAR(1) ,
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M33Key1 PRIMARY KEY (M33_ID)) ;
   CREATE UNIQUE INDEX M33UK1 ON M33JABT (Kode) ;
...
CREATE TABLE M22JNSP(
   ...
   Ws VARCHAR(1) ,
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M22Key1 PRIMARY KEY (M22_ID)) ;
   CREATE UNIQUE INDEX M22UK1 ON M22JNSP(KdJnsP) ;
...
CREATE TABLE T05HPIU(
   ...
   M22_ID INTEGER, 
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT T05Key1 PRIMARY KEY (NIP,KdJnsP,TgDoku)) ;
...
ALTER TABLE T06DPIU ADD
   CONSTRAINT T06Key2 FOREIGN KEY (NIP,KdJnsP,TgDoku)
   REFERENCES T05HPIU(NIP,KdJnsP,TgDoku)  ON DELETE CASCADE ; 
...
ALTER TABLE T07BAYP ADD
   CONSTRAINT T07Key2 FOREIGN KEY (NIP,KdJnsP,TgPiut)
   REFERENCES T05HPIU(NIP,KdJnsP,TgDoku)  ON DELETE CASCADE ; 
...
CREATE TABLE M03DPPT(
   ...
   M40_ID INTEGER, 
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M03Key1 PRIMARY KEY (FlgDpPt,KdDpPt)) ; 
...
create INDEX M11Key2 ON M11GGOL(Kode) ; 
...
ALTER TABLE M11GGOL ADD
   CONSTRAINT M11Key2 FOREIGN KEY (Kode) 
   REFERENCES M12HGOL(Kode) ON UPDATE RESTRICT ON DELETE RESTRICT ;
ALTER TABLE M11GGOL ADD
...
create INDEX M20Key2 ON M20DSLG(TipeLap,FlgDpPt,NomFormat) ;
create INDEX M20Key3 ON M20DSLG(FlgDpPt,KdDpPt) ;
...
ALTER TABLE M20DSLG ADD
   CONSTRAINT M20Key2 FOREIGN KEY (TipeLap,FlgDpPt,NomFormat)
   REFERENCES M19HSLG(TipeLap,FlgDpPt,NomFormat)  ON DELETE CASCADE ;
ALTER TABLE M20DSLG ADD
   CONSTRAINT M20Key3 FOREIGN KEY (FlgDpPt,KdDpPt)
   REFERENCES M03DPPT(FlgDpPt,KdDpPt) ON UPDATE RESTRICT ON DELETE RESTRICT ;
...
CREATE TABLE M41JPJK(
   ...
   Ws VARCHAR(1) ,
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M41Key1 PRIMARY KEY (M41_ID)) ; 

   CREATE UNIQUE INDEX M41UK1 ON M41JPJK (Kode) ;
...
CREATE TABLE M44JASU(
   ...
   M03_ID INTEGER, 
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M44Key1 PRIMARY KEY (M44_ID)) ;

   CREATE UNIQUE INDEX M44UK1 ON M44JASU (Kode) ;

create INDEX M44Key2 ON M44JASU(FlgDpPt1,KdDpPt1) ; 
...
ALTER TABLE M44JASU ADD
   CONSTRAINT M44Key2 FOREIGN KEY (FlgDpPt1,KdDpPt1)
   REFERENCES M03DPPT(FlgDpPt,KdDpPt) ON UPDATE RESTRICT ON DELETE RESTRICT ;
...
CREATE TABLE M45KKHS(
   ...
   M15_ID INTEGER, 
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M45Key1 PRIMARY KEY (M45_ID)) ; 

   CREATE UNIQUE INDEX M45UK1 ON M45KKHS (NIP) ;
...
CREATE TABLE M47PRLR(
   ...
   Ws VARCHAR(1) ,
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M47Key1 PRIMARY KEY (M47_ID));

   CREATE UNIQUE INDEX M47UK1 ON M47PRLR (TglProses) ;
...
create INDEX T02Key3 ON T02ABSN(FlgDpPt,KdDpPt) ;
...
ALTER TABLE T02ABSN ADD
   ...
   REFERENCES M15PEGA(NIP) ON UPDATE RESTRICT ON DELETE RESTRICT ;
ALTER TABLE T02ABSN ADD
   CONSTRAINT T02Key3 FOREIGN KEY (FlgDpPt,KdDpPt)
   REFERENCES M03DPPT(FlgDpPt,KdDpPt) ON UPDATE RESTRICT ON DELETE RESTRICT ;
...
CREATE TABLE T03VARI(
   ...
   M40_ID INTEGER, 
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT T03Key1 PRIMARY KEY (NIP,FlgDpPt,KdDpPt,PrdMulai,PrdSd)) ; 

   CREATE UNIQUE INDEX T03UK1 ON T03VARI (NIP,FlgDpPt,KdDpPt,PrdMulai,PrdSd) ;

create INDEX T03Key2 ON T03VARI(NIP) ;
create INDEX T03Key3 ON T03VARI(FlgDpPt,KdDpPt) ;
...
ALTER TABLE T03VARI ADD
   ...
   REFERENCES M15PEGA(NIP) ON UPDATE RESTRICT ON DELETE RESTRICT ;
ALTER TABLE T03VARI ADD
   CONSTRAINT T03Key3 FOREIGN KEY (FlgDpPt,KdDpPt)
   REFERENCES M03DPPT(FlgDpPt,KdDpPt) ON UPDATE RESTRICT ON DELETE RESTRICT ;
ALTER TABLE T03VARI ADD
...
create INDEX T04Key3 ON T04TTAP(FlgDpPt,KdDpPt) ;
...
ALTER TABLE T04TTAP ADD
   ...
   REFERENCES M15PEGA(NIP) ON UPDATE RESTRICT ON DELETE RESTRICT ;
ALTER TABLE T04TTAP ADD
   CONSTRAINT T04Key3 FOREIGN KEY (FlgDpPt,KdDpPt)
   REFERENCES M03DPPT(FlgDpPt,KdDpPt) ON UPDATE RESTRICT ON DELETE RESTRICT ;
ALTER TABLE T04TTAP ADD
...
create INDEX T17Key3 ON T17PDAK(FlgDpPt,KdDpPt) ;
...
ALTER TABLE T17PDAK ADD
   ...
   REFERENCES M15PEGA(NIP) ON UPDATE RESTRICT ON DELETE RESTRICT ;
ALTER TABLE T17PDAK ADD
   CONSTRAINT T17Key3 FOREIGN KEY (FlgDpPt,KdDpPt)
   REFERENCES M03DPPT(FlgDpPt,KdDpPt) ON UPDATE RESTRICT ON DELETE RESTRICT ;
...
create INDEX T16Key3 ON T16PKON(Jabatan) ;
...
--
ALTER TABLE T16PKON ADD
   CONSTRAINT T16Key3 FOREIGN KEY (Jabatan)
   REFERENCES M04HJAB(Kode) ON UPDATE RESTRICT ON DELETE RESTRICT ;
--
ALTER TABLE T16PKON ADD
...
CREATE TABLE T18HKER(
   ...
   M15_ID INTEGER, 
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT T18Key1 PRIMARY KEY (NIP,InOut)) ;
...
CREATE TABLE T19PESA(
   ...
   M40_ID INTEGER, 
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT T19Key1 PRIMARY KEY (T19_ID)) ; 

   CREATE UNIQUE INDEX T19UK1 ON T19PESA (NIP) ;
...
CREATE TABLE T22KPAS(
   ...
   M44_ID INTEGER, 
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT T22Key1 PRIMARY KEY (NIP,Kode)) ;
...
create INDEX T23Key3 ON T23MPEG(FlgDpPt,KdDpPt) ;
...
ALTER TABLE T23MPEG ADD
   ...
   REFERENCES M15PEGA(NIP) ON UPDATE RESTRICT ON DELETE RESTRICT ;
ALTER TABLE T23MPEG ADD
   CONSTRAINT T23Key3 FOREIGN KEY (FlgDpPt,KdDpPt)
   REFERENCES M03DPPT(FlgDpPt,KdDpPt) ON UPDATE RESTRICT ON DELETE RESTRICT ;
ALTER TABLE T23MPEG ADD
...
CREATE TABLE T24PDLL(
   ...
   M15_ID INTEGER, 
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT T24Key1 PRIMARY KEY (T24_ID)) ; 

   CREATE UNIQUE INDEX T24UK1 ON T24PDLL (NIP) ;
...
CREATE TABLE T25OPBP(
   ...
   m15_id integer,
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT T25Key1 PRIMARY KEY (T25_ID)); 

   CREATE UNIQUE INDEX T25UK1 ON T25OPBP (NIP) ;
...
ALTER TABLE S02DGAJ ADD
   CONSTRAINT S02Key2 FOREIGN KEY (TglPayr,NIP)
   REFERENCES S01HGAJ(TglPayr,NIP)  ON DELETE CASCADE ;
...
-- DETAIL JABATAN
ALTER TABLE M05DJAB ADD
   CONSTRAINT M05Key3 FOREIGN KEY (FlgDpPt,KdDpPt)
   REFERENCES M03DPPT(FlgDpPt,KdDpPt) ON UPDATE RESTRICT ON DELETE RESTRICT ;

-- DETAIL KELOMPOK JABATAN
ALTER TABLE M07DKJB ADD
   CONSTRAINT M07Key3 FOREIGN KEY (FlgDpPt,KdDpPt)
   REFERENCES M03DPPT(FlgDpPt,KdDpPt) ON UPDATE RESTRICT ON DELETE RESTRICT ;

-- DETAIL CABANG
ALTER TABLE M09DCAB ADD
   CONSTRAINT M09Key3 FOREIGN KEY (FlgDpPt,KdDpPt)
   REFERENCES M03DPPT(FlgDpPt,KdDpPt) ON UPDATE RESTRICT ON DELETE RESTRICT ;
...
-- DETAIL GOLONGAN
ALTER TABLE M13DGOL ADD
   CONSTRAINT M13Key3 FOREIGN KEY (FlgDpPt,KdDpPt)
   REFERENCES M03DPPT(FlgDpPt,KdDpPt) ON UPDATE RESTRICT ON DELETE RESTRICT ;
...
CREATE TABLE M24MUTR(
   ...
   CREATE UNIQUE INDEX M24UK1 ON M24MUTR(KdMutr) ;
...
CREATE TABLE M25JNSD(
   ...
   Ws VARCHAR(1) ,
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M25Key1 PRIMARY KEY (M25_ID)) ; 

   CREATE UNIQUE INDEX M25UK1 ON M25JNSD (Kode) ;
...
CREATE TABLE M26JRSN(
   ...
   Ws VARCHAR(1) ,
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M26Key1 PRIMARY KEY (M26_ID)) ; 

   CREATE UNIQUE INDEX M26UK1 ON M26JRSN (Kode) ;
...
CREATE TABLE M27LMBD(
   ...
   Ws VARCHAR(1) ,
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M27Key1 PRIMARY KEY (M27_ID)) ; 

   CREATE UNIQUE INDEX M27UK1 ON M27LMBD (Kode) ;
...
CREATE TABLE M28LKSD(
   ...
   Ws VARCHAR(1) ,
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M28Key1 PRIMARY KEY (M28_ID)) ; 

   CREATE UNIQUE INDEX M28UK1 ON M28LKSD (Kode) ;
...
CREATE TABLE M29JNSA(
   ...
   Ws VARCHAR(1) ,
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M29Key1 PRIMARY KEY (M29_ID)) ; 
...
CREATE TABLE M30HAHU(
   ...
   Ws VARCHAR(1) ,
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M30Key1 PRIMARY KEY (M30_ID)) ;

   CREATE UNIQUE INDEX M30UK1 ON M30HAHU (KdHarg) ;
...
CREATE TABLE M31FASL(
   ...
   Ws VARCHAR(1) ,
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M31Key1 PRIMARY KEY (M31_ID)) ; 
...
CREATE TABLE M32JMED(
   ...
   Ws VARCHAR(1) ,
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M32Key1 PRIMARY KEY (M32_ID)) ; 

   CREATE UNIQUE INDEX M32UK1 ON M32JMED (Kode) ;
...
CREATE TABLE M34HOBI(
   ...
   Ws VARCHAR(1) ,
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M34Key1 PRIMARY KEY (M34_ID)) ;
...
CREATE TABLE M36JBHS(
   ...
   Ws VARCHAR(1) ,
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M36Key1 PRIMARY KEY (M36_ID)) ; 

   CREATE UNIQUE INDEX M36UK1 ON M36JBHS (Kode) ;
...
CREATE TABLE M42TSPL(
   ...
   Ws VARCHAR(1) ,
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M42Key1 PRIMARY KEY (M42_ID)) ; 

   CREATE UNIQUE INDEX M42UK1 ON M42TSPL (Kode) ;
...
CREATE TABLE M43SUPL(
   ...
   M42_ID INTEGER, 
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M43Key1 PRIMARY KEY (M43_ID)) ; 

   CREATE UNIQUE INDEX M43UK1 ON M43SUPL (Kode) ;
...
CREATE TABLE M48PCUT(
   ...
   Keterangan VARCHAR(100) ,
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M48Key1 PRIMARY KEY (M48_ID)) ; 

   CREATE UNIQUE INDEX M48UK1 ON M48PCUT (Kode) ;
...
ALTER TABLE M35HOBI ADD
   ...
   REFERENCES M34HOBI(Kode)  ON DELETE CASCADE ;
...
CREATE TABLE M38PKRJ(
   ...
   M15_ID INTEGER, 
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M38Key1 PRIMARY KEY (NIP,TglMasuk)) ;
...
CREATE TABLE M51JFRM(
   ...
   Ws VARCHAR(1) ,
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M51Key1 PRIMARY KEY (M51_ID)) ; 

   CREATE UNIQUE INDEX M51UK1 ON M51JFRM(KdJFrm) ;
...
create INDEX M53Key2 ON M53DFRM(KdJFrm,NomFormat) ;
create INDEX M53Key3 ON M53DFRM(FlgDpPt,KdDpPt) ;
...
ALTER TABLE M53DFRM ADD
   CONSTRAINT M53Key3 FOREIGN KEY (FlgDpPt,KdDpPt)
   REFERENCES M03DPPT(FlgDpPt,KdDpPt) ON UPDATE RESTRICT ON DELETE RESTRICT ;

ALTER TABLE M53DFRM ADD
   CONSTRAINT M53Key2 FOREIGN KEY (KdJFrm,NomFormat)
   REFERENCES M52HFRM(KdJFrm,NomFormat)
	ON DELETE CASCADE  ;
...
create INDEX T10Key6 ON T10MUTA(KdCaba) ;
create INDEX T10Key7 ON T10MUTA(KdUUsa) ;
create INDEX T10Key8 ON T10MUTA(KdUKer) ;
create INDEX T10Key9 ON T10MUTA(KdGlng) ;
create INDEX T10Key10 ON T10MUTA(KdJaba) ;
create INDEX T10Key11 ON T10MUTA(KdArea) ;
create INDEX T10Key12 ON T10MUTA(KdKJab) ;
...
ALTER TABLE T10MUTA ADD
   ...
   REFERENCES M10KLAS(Kode) ON UPDATE RESTRICT ON DELETE RESTRICT ;
ALTER TABLE T10MUTA ADD
   CONSTRAINT T10Key6 FOREIGN KEY (KdCaba)
   REFERENCES M08HCAB(KdCaba) ON UPDATE RESTRICT ON DELETE RESTRICT ;
ALTER TABLE T10MUTA ADD
...
ALTER TABLE T10MUTA ADD
   ...
   REFERENCES M17UKER(KdUker) ON UPDATE RESTRICT ON DELETE RESTRICT ;
ALTER TABLE T10MUTA ADD
   CONSTRAINT T10Key9 FOREIGN KEY (KdGlng)
   REFERENCES M12HGOL(Kode) ON UPDATE RESTRICT ON DELETE RESTRICT ;
ALTER TABLE T10MUTA ADD
   CONSTRAINT T10Key10 FOREIGN KEY (KdJaba)
   REFERENCES M04HJAB(Kode) ON UPDATE RESTRICT ON DELETE RESTRICT ;
ALTER TABLE T10MUTA ADD
   CONSTRAINT T10Key11 FOREIGN KEY (KdArea)
   REFERENCES M01AREA(Kode) ON UPDATE RESTRICT ON DELETE RESTRICT ;
ALTER TABLE T10MUTA ADD
   CONSTRAINT T10Key12 FOREIGN KEY (KdKJab)
   REFERENCES M06HKJB(Kode) ON UPDATE RESTRICT ON DELETE RESTRICT ;
...
create INDEX T12Key2 ON T12DTRN(TgDocu,KdJnsD,KdJrsn) ;
...
ALTER TABLE T12DTRN ADD
   CONSTRAINT T12Key2 FOREIGN KEY (TgDocu,KdJnsD,KdJrsn)
   REFERENCES T11HTRN(TgDocu,KdJnsD,KdJrsn) ON UPDATE RESTRICT ON DELETE CASCADE ;
ALTER TABLE T12DTRN ADD
...
create INDEX T15Key2 ON T15PMED(NIP,Tahun) ;
...
ALTER TABLE T15PMED ADD
   CONSTRAINT T15Key2 FOREIGN KEY (NIP,Tahun)
   REFERENCES T14JTHM(NIP,Tahun) ON UPDATE RESTRICT ON DELETE RESTRICT ;
ALTER TABLE T15PMED ADD
...
create INDEX T20Key3 ON T20JTMJ(KelJab) ;
...
ALTER TABLE T20JTMJ ADD
   ...
   REFERENCES M32JMED(Kode) ON UPDATE RESTRICT ON DELETE RESTRICT ;
ALTER TABLE T20JTMJ ADD
   CONSTRAINT T20Key3 FOREIGN KEY (KelJab)
   REFERENCES M06HKJB(Kode) ON UPDATE RESTRICT ON DELETE RESTRICT ;
...
CREATE TABLE S09HCUT(
   ...
   keterangan VARCHAR(100), 
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT S09Key1 PRIMARY KEY (NIP,Tahun)) ;
...
CREATE TABLE S0ADCUT(
   ...
   S09_ID INTEGER, 
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT S0AKey1 PRIMARY KEY (NIP,Tahun,BlnTgl,KdCuti)) ;

   CREATE UNIQUE INDEX S0AUK1 ON S0ADCUT(NIP,Tahun,BlnTgl,KdCuti) ;

create INDEX S0AKey2 ON S0ADCUT(NIP,Tahun) ;
...
ALTER TABLE S0ADCUT ADD
   CONSTRAINT S0AKey2 FOREIGN KEY (NIP,Tahun)
   REFERENCES S09HCUT(NIP,Tahun) ON UPDATE RESTRICT ON DELETE CASCADE ;
...
create INDEX S0DKey2 ON S0DMEDD(NIP,Tahun,JenisMedical) ;
...
ALTER TABLE S0DMEDD ADD
   CONSTRAINT S0DKey2 FOREIGN KEY (NIP,Tahun,JenisMedical)
   REFERENCES S0CMEDH(NIP,Tahun,JenisMedical) ON UPDATE RESTRICT ON DELETE CASCADE ;
...
CREATE TABLE M54PARA(
   ...
   Ws VARCHAR(1) ,
	...
	UPDATED_BY varchar(15) NULL,
	UPDATED_ON timestamp  NULL,
   CONSTRAINT M54Key1 PRIMARY KEY (M54_ID)) ; 

   CREATE UNIQUE INDEX M54UK1 ON M54PARA(RID) ;
...
create INDEX M56Key3 ON M56NGRP(RID,KdPGrp) ;
...
ALTER TABLE M56NGRP ADD
   CONSTRAINT M56Key3 FOREIGN KEY (RID,KdPGrp)
   REFERENCES M55PGRP(RID,Kode) ON UPDATE RESTRICT ON DELETE RESTRICT ;
...
create INDEX M58Key2 ON M58PRED(KdJAsu,LvlBenefit) ; 
create INDEX M58Key3 ON M58PRED(KdKJab) ;

ALTER TABLE M58PRED ADD
   CONSTRAINT M58Key3 FOREIGN KEY (KdKJab)
   REFERENCES M06HKJB(Kode) ON UPDATE RESTRICT ON DELETE RESTRICT ; 

ALTER TABLE M58PRED ADD
   CONSTRAINT M58Key2 FOREIGN KEY (KdJAsu,LvlBenefit)
   REFERENCES M57PREH(KdJAsu,LvlBenefit) ON DELETE CASCADE ;
...
create INDEX M59Key2 ON M59PRE2(KdJAsu,LvlBenefit) ;

ALTER TABLE M59PRE2 ADD
   CONSTRAINT M59Key2 FOREIGN KEY (KdJAsu,LvlBenefit)
   REFERENCES M57PREH(KdJAsu,LvlBenefit) ON DELETE CASCADE ;
...
create INDEX S0GKey3 ON S0GPREM(FlgDpPt,KdDpPt) ;
...
create INDEX M60Key2 ON M60TSHT(RID,KdPGrp) ;
...
ALTER TABLE M60TSHT ADD
   CONSTRAINT M60Key2 FOREIGN KEY (RID,KdPGrp)
   REFERENCES M55PGRP(RID,Kode) ON UPDATE RESTRICT ON DELETE RESTRICT ;
...
CREATE TABLE M61DBCB(
   ...
   CREATE UNIQUE INDEX M61UK1 ON M61DBCB (KdCaba) ;
...
create INDEX M65Key2 ON M65ADVD(Level1,Kode1,Level2,Kode2) ;
create INDEX M65Key3 ON M65ADVD(FlgDpPt,KdDpPt) ;
...
ALTER TABLE M65ADVD ADD
   CONSTRAINT M65Key2 FOREIGN KEY (Level1,Kode1,Level2,Kode2)
   REFERENCES M64ADVH(Level1,Kode1,Level2,Kode2)
	ON DELETE CASCADE ;

ALTER TABLE M65ADVD ADD
   CONSTRAINT M65Key3 FOREIGN KEY (FlgDpPt,KdDpPt)
   REFERENCES M03DPPT(FlgDpPt,KdDpPt) ON UPDATE RESTRICT ON DELETE RESTRICT ;
