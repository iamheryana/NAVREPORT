/****************************************
Name sprocs	: R_ARSUP1
Create by	: Deni
Date		: 03-09-2002
Description	: Arsip Gaji per Unit Usaha dan Cabang
*****************************************/
DROP FUNCTION R_ARSUP1(l_Periode	DATE,
                        l_NIPFr     VARCHAR(10),
                        l_NIPTo     VARCHAR(10),
                        l_UUsaFr	VARCHAR(4),
                        l_UUsaTo	VARCHAR(4),
                        ...
                        l_UserId    INT) ;
--
CREATE FUNCTION R_ARSUP1(l_Periode	DATE,
                        l_NIPFr     VARCHAR(10),
                        l_NIPTo     VARCHAR(10),
                        l_UUsaFr	VARCHAR(4),
                        l_UUsaTo	VARCHAR(4),
...
BEGIN
    ...
    --
    RETURN QUERY
    SELECT  Q1.Tahun, Q1.Bulan, Q1.NIP, Q1.Nama, Q1.KdUUsa, Q1.KetUsaha, Q1.KdCaba, Q1.NmCaba,
            ...
            SUM(CASE WHEN Q1.FlgDpPt='P' AND Q1.NoUrut>15 THEN Q1.Nilai ELSE 0 END) Pot16,         
    ...
    SELECT 	TO_CHAR(S01.TglPayr,'YYYY') :: VARCHAR(4) AS Tahun, 
            ...
            S01.NIP, S01.Nama, S01.KdUUsa, M02.Keterangan AS KetUsaha, M08.KdCaba, M08.NmCaba,
            S01.KdGLng, S01.JnsKlmn,S01.TotAnak,S01.StsPjk, M19.FlgDpPt, M19.NomFormat,
    ...
    GROUP BY Q1.Tahun, Q1.Bulan, Q1.NIP, Q1.Nama, Q1.KdUUsa, Q1.KetUsaha, Q1.KdCaba, Q1.NmCaba,
             Q1.KdGLng, Q1.JnsKlmn, Q1.TotAnak, Q1.StsPjk,
             Q1.Pendapatan1, Q1.Pendapatan2, Q1.Pendapatan3, Q1.Pendapatan4, Q1.Pendapatan5, Q1.Pendapatan6, 
             Q1.Pendapatan7, Q1.Pendapatan8, Q1.Pendapatan9, Q1.Pendapatan10, Q1.Pendapatan11, Q1.Pendapatan12, 
             Q1.Pendapatan13,Q1.Pendapatan14,Q1.Pendapatan15,Q1.Pendapatan16,
...
select * from R_ARSUP1('2013-12-01',' ','ZZZ',' ','ZZZ','Copyright, 1988 (c) Microsoft Corporation, All rights reserved', 1)
*/
