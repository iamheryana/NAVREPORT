CREATE OR REPLACE FUNCTION l_m29jnsa(IN l_kodeFr character varying, IN l_kodeTo character varying)
...
BEGIN
	RETURN QUERY 
	SELECT  m29.kode as OutKode, m29.nama as OutKeterangan, m29.singkatan as OutSingkatan, m29.version as OutVersion, 
		m29.created_by as OutCreated_by, m29.created_on as OutCreated_on, m29.updated_by as OutUpdated_by,
