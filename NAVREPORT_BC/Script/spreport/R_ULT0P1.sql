...
********************************************************/
DROP FUNCTION  R_ULT0P1 (
                    l_P_TGLFR 	INT, 
					l_P_BLNFR 	INT, 
					l_P_TGLTO 	INT, 
					l_P_BLNTO 	INT,
					l_P_UKERFR	VARCHAR(8), 
					l_P_UKERTO	VARCHAR(8),
					l_sts    	VARCHAR(1),
					l_tglstatus DATE,
                    l_UserId    INT);
--
CREATE OR REPLACE FUNCTION  R_ULT0P1 (
                    l_P_TGLFR 	INT, 
					l_P_BLNFR 	INT, 
					l_P_TGLTO 	INT, 
					l_P_BLNTO 	INT,
...
BEGIN 
	...
	SELECT  M15.NIP,M15.Nama,M15.JnsKlmn,M15.TglLahir,
    	    ...
    	    M15.KdCaba,M08.SkCaba,M15.KdUUsa,M02.Singkatan AbbrUUsa,
		    M15.KdUKer,M17.Singkatan AbbrUKer,M15.KdJaba,M04.Keterangan
	FROM M15PEGA M15
	...
	WHERE (TO_CHAR(M15.TglLahir,'MMDD') BETWEEN l_P_PERIODEFR AND l_P_PERIODETO) AND 
	      (M15.KdUKer BETWEEN l_P_UKERFR AND l_P_UKERTO) AND 
          ( l_sts = 'S' OR 
...
/* TESTING...
select * from R_ULT0P1(1, 3, 31, 3, ' ', 'ZZZZZZZZ', 'A', '2013-11-08', 1)
*/
