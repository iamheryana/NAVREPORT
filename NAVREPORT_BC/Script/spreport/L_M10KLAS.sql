CREATE OR REPLACE FUNCTION l_m10klas(IN l_kodeFr character varying, IN l_kodeTo character varying)
...
DROP FUNCTION l_m10klas(character varying, character varying);

SELECT * FROM l_m10klas('.','ZZZ')
