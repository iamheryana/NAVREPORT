/****************************************
Name sprocs	: R_ARSVP1
Create by	: Deni
Date		: 25-09-2001
Description	: Proses Untuk Laporan ARSIP GAJI peer Valuta
Note		: Kolom NoKPA di W06 ini dipakai untuk Status pajak dari S01
*****************************************/
DROP FUNCTION R_ARSVP1 (l_Periode DATE,
                        l_NIPFr     VARCHAR(10),
                        l_NIPTo     VARCHAR(10),
                        l_FCab      VARCHAR(4),
                        l_TCab      VARCHAR(4),
                        ...
                        l_UserId    INT) ;
--
CREATE FUNCTION R_ARSVP1 (l_Periode DATE,
                        l_NIPFr     VARCHAR(10),
                        l_NIPTo     VARCHAR(10),
                        l_FCab      VARCHAR(4),
                        l_TCab      VARCHAR(4),
...
BEGIN
    ...
    --
    RETURN QUERY
    SELECT  Q1.Tahun, Q1.Bulan, Q1.NIP, Q1.Nama, Q1.KdUUsa, Q1.KetUsaha, Q1.KdArea, 
            Q1.SkArea, Q1.KdCaba, Q1.SkCaba, Q1.KdUKer, Q1.SkUker, Q1.KdKlas, Q1.SkKlas, 
            Q1.KdGlng, Q1.FlgDpPt, Q1.JnsKlmn, Q1. TotAnak, Q1.StsPjk,
    ...
    SELECT 	TO_CHAR(S01.TglPayr,'YYYY') :: VARCHAR(4) AS Tahun, 
            ...
            S01.NIP, S01.Nama, S01.KdUUsa, M02.Keterangan AS KetUsaha, S01.KdArea, 
            M01.Singkatan AS SkArea, S01.KdCaba, M08.SkCaba, S01.KdUKer, M17.Singkatan AS SkUker,
            S01.KdKlas, M10.Singkatan AS SkKlas, S01.KdGlng, 
            M19.FlgDpPt, M19.NomFormat, S01.JnsKlmn, S01. TotAnak, S01.StsPjk,
    ...
    WHERE M19.TipeLap='2' AND S02.KdCurr=l_kdCurr AND --M19.FlgDpPt='D' AND
          S01.NIP	BETWEEN l_NIPFr	AND l_NIPTo AND
          S01.KdCaba BETWEEN l_FCab AND l_TCab AND
          TO_CHAR(S01.TglPayr,'YYYYMM')=TO_CHAR(l_Periode,'YYYYMM')
    ) Q1      
    GROUP BY Q1.Tahun, Q1.Bulan, Q1.NIP, Q1.Nama, Q1.KdUUsa, Q1.KetUsaha, Q1.KdArea, 
             Q1.SkArea, Q1.KdCaba, Q1.SkCaba, Q1.KdUKer, Q1.SkUker, Q1.KdKlas, Q1.SkKlas, 
             Q1.KdGlng, Q1.FlgDpPt, Q1.JnsKlmn, Q1. TotAnak, Q1.StsPjk,
             Q1.Pendapatan1, Q1.Pendapatan2, Q1.Pendapatan3, Q1.Pendapatan4, Q1.Pendapatan5, Q1.Pendapatan6, 
             Q1.Pendapatan7, Q1.Pendapatan8, Q1.Pendapatan9, Q1.Pendapatan10, Q1.Pendapatan11, Q1.Pendapatan12, 
...
select * from R_ARSVP1('2013-12-01',' ','ZZZ',' ','ZZZ','IDR','Copyright, 1988 (c) Microsoft Corporation, All rights reserved', 1)
