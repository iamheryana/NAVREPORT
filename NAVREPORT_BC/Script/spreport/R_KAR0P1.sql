/****************************************
Name sprocs	: R_KAR0P1
Create by	: Deni
Date		: 19-02-2014
Description	: Proses Untuk Report Kartu Slip Total per Unit Kerja
*****************************************/
DROP FUNCTION R_KAR0P1 (l_Tahun   VARCHAR(4),
                        l_NIPFr     VARCHAR(10),
                        l_NIPTo     VARCHAR(10),
                        l_PendFr    VARCHAR(4),
                        l_PendTo	VARCHAR(4),
                        ...
                        l_UserId	INT);
--
CREATE FUNCTION R_KAR0P1 (l_Tahun   VARCHAR(4),
                        l_NIPFr     VARCHAR(10),
                        l_NIPTo     VARCHAR(10),
                        l_PendFr    VARCHAR(4),
                        l_PendTo	VARCHAR(4),
...
select * from R_KAR0P1('2013',' ','ZZZ',' ','ZZZ',' ','ZZZ','Copyright, 1988 (c) Microsoft Corporation, All rights reserved', 1)
*/
