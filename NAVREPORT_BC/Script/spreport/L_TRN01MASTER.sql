...
CREATE OR REPLACE FUNCTION public.l_trn01master (in l_kodefr varchar, in l_kodeto varchar, in outkodemaster varchar, in outketerangan varchar, in outsingkatan varchar, in outversion int4, in outcreated_by varchar, in outcreated_on timestamp, in outupdated_by varchar, in outupdated_on timestamp) RETURNS SETOF record AS
$BODY$ 
BEGIN
	RETURN QUERY
