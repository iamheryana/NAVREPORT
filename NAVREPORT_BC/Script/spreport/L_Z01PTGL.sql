DROP FUNCTION l_z01ptgl(IN l_cbngFr character varying, 
...
--
CREATE FUNCTION l_z01ptgl(IN l_cbngFr character varying, 
                                                    IN l_cbngTo character varying,
                                                    IN l_applydateFr date, 
                                                    IN l_applydateTo date,
                                                    IN l_accountcodeFr character varying, 
...
BEGIN
 RETURN QUERY
	SELECT	z01.kdcabang as OutCabang,
            ...
            z01.debit as OutDebit,
            z01.credit as OutCredit,
