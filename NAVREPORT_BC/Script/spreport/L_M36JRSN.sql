CREATE OR REPLACE FUNCTION l_m36jrsn(IN l_kodeFr character varying, IN l_kodeTo character varying)
...
BEGIN
	RETURN QUERY 
	SELECT  m36.kode as OutKode, m36.nama as OutKeterangan, m36.version as OutVersion, 
